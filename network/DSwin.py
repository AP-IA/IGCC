"""
Based on DynamicViT https://github.com/raoyongming/DynamicViT/blob/master/models/dyswin.py
"""
import math
...
class AdaSwinTransformer(nn.Module):
    ...
    def forward_features(self, x):
        ...
        return x, patch_x, decision_mask.unsqueeze(-1).detach(), decision_mask_list, feature_list
